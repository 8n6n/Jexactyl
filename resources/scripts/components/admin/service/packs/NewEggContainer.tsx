...
import type { EggProcessContainerRef } from '@admin/service/packs/eggs/EggSettingsContainer';
import {
    EggImageContainer,
    ...
    EggProcessContainer,
    EggStartupContainer,
} from '@admin/service/packs/eggs/EggSettingsContainer';
...
export default () => {
    ...
    const submit = async (values: Values, { setSubmitting }: FormikHelpers<Values>) => {
        ...
        createEgg({
            ...
            .then(egg => navigate(`/admin/packs/${packId}/eggs/${egg.id}`))
            .catch(error => {
                console.error(error);
