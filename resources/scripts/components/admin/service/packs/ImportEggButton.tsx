...
import getEggs from '@/api/admin/packs/getEggs';
import importEgg from '@/api/admin/packs/importEgg';
...
export default ({ className }: { className?: string }) => {
    ...
    const { mutate } = getEggs(Number(params.packId));
        ...
        if (file) {
            ...
            reader.onload = async e => {
                ...
                try {
                    ...
                    const egg = await importEgg(Number(params.packId), jsonData);
