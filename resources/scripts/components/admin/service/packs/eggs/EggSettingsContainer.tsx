...
import EggDeleteButton from '@admin/service/packs/eggs/EggDeleteButton';
import EggExportButton from '@admin/service/packs/eggs/EggExportButton';
                ...
                <Form>
                    ...
                    <div css={tw`rounded shadow-md px-4 xl:px-5 py-4 mb-16`} style={{ backgroundColor: secondary }}>
                        <div css={tw`flex flex-row`}>
                            <EggDeleteButton eggId={egg.id} onDeleted={() => navigate('/admin/packs')} />
