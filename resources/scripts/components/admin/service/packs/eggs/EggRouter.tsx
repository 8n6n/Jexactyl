...
import EggInstallContainer from '@admin/service/packs/eggs/EggInstallContainer';
import EggVariablesContainer from '@admin/service/packs/eggs/EggVariablesContainer';
import useFlash from '@/plugins/useFlash';
import AdminContentBlock from '@elements/AdminContentBlock';
import Spinner from '@elements/Spinner';
import FlashMessageRender from '@/components/FlashMessageRender';
import { SubNavigation, SubNavigationLink } from '@admin/SubNavigation';
import EggSettingsContainer from '@admin/service/packs/eggs/EggSettingsContainer';
import { useStoreState } from '@/state/hooks';

const EggRouter = () => {
    const { id, packId } = useParams<'packId' | 'id'>();
    ...
    return (
        <AdminContentBlock title={'Egg - ' + egg.name}>
            ...
            <SubNavigation theme={theme}>
                <SubNavigationLink to={`/admin/packs/${packId ?? ''}/eggs/${id ?? ''}`} name={'About'} base>
                ...
                <SubNavigationLink to={`/admin/packs/${packId ?? ''}/eggs/${id ?? ''}/variables`} name={'Variables'}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M5 4a1 1 0 00-2 0v7.268a2 2 0 000 3.464V16a1 1 0 102 0v-1.268a2 2 0 000-3.464V4zM11 4a1 1 0 10-2 0v1.268a2 2 0 000 3.464V16a1 1 0 102 0V8.732a2 2 0 000-3.464V4zM16 3a1 1 0 011 1v7.268a2 2 0 010 3.464V16a1 1 0 11-2 0v-1.268a2 2 0 010-3.464V4a1 1 0 011-1z" />
                    </svg>
                </SubNavigationLink>

                <SubNavigationLink to={`/admin/packs/${packId ?? ''}/eggs/${id ?? ''}/install`} name={'Install Script'}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path
                            clipRule="evenodd"
                            fillRule="evenodd"
