...
return [
    'notices' => [
        'created' => 'A new pack, :name, has been successfully created.',
        'deleted' => 'Successfully deleted the requested pack from the Panel.',
        'updated' => 'Successfully updated the pack configuration options.',
    ],
    'eggs' => [
        'notices' => [
